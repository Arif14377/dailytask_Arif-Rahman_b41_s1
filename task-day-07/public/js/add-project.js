                ...
                <div class="col" id="contents">
                    <div class="card h-100 px-3 py-2 mt-5 shadow">
                        ...
                        <div class="d-flex ms-2 my-3">
                            <img src="/public/img/playstore.png" alt="playstore icon"
                                style="width: 30px; margin-right: 20px;">
                            <img src="/public/img/android.png" alt="android icon"
                                style="width: 30px; margin-right: 20px;">
                            <img src="/public/img/java.png" alt="java icon" style="width: 30px">
                        </div>
